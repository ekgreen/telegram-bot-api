...
* [Обзор](#overview)
* [Клиент](#client)
    - [Начало работы](#client-getting-started)
	    - [Создание клиента](#client-creation)
	    - [Примеры вызовов](#client-examples)
    - [Развитие](#client-research)
* [Сервер](#server)
    - [Начало работы](#server-getting-started)
	- [Фичи](#server-features)
	    -[Команды](#server-features-commands)
	    -[Маппинг параметров запроса](#server-features-mapping)
	    -[Ответ на запрос](#server-features-response)
    - [Архитектура решения](#server-architecture)
	    -[Платформа](#server-architecture-platform)
	    -[Продюсеры](#server-architecture-producers)
	    -[Gateway](#server-architecture-gateway)
	- [Развитие](#server-research)
* [Лицензия](#license)
